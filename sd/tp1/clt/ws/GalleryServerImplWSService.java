 ...
 * 
 */
@WebServiceClient(name = "GalleryServerImplWSService", targetNamespace = "http://srv.tp1.sd/", wsdlLocation = "http://localhost:8080/GalleryServerSOAP?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/GalleryServerSOAP?wsdl");
